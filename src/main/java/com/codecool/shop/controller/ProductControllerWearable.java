...
@WebServlet(urlPatterns = {"wearable"})
public class ProductControllerWearable extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse res)
        ...
        res.sendRedirect(res.encodeRedirectURL(req.getContextPath() + "/wearable"));
