...
@WebServlet(urlPatterns = {"spaceships"})
public class ProductControllerSpaceships extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        context.setVariable("category", productCategoryDataStore.find(3));
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse res)
        ...
        res.sendRedirect(res.encodeRedirectURL(req.getContextPath() + "/spaceships"));
